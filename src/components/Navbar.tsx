...
const navigation: MenuItem[] = [
    /*
    { name: 'Dashboard', page: '/login', current: true },
    { name: 'Team', page: '/login', current: false },
    { name: 'Projects', page: '/login', current: false },
    { name: 'Calendar', page: '/login', current: false },
    */
]
                                            ...
                                            <div>
                                                <Menu.Button className="flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                                                    ...
                                                    <img
                                                        ...
                                                        src={`https://ui-avatars.com/api/?name=${client.authStore.model?.email}`}
                                                        alt=""
                                                    />
                                                </Menu.Button>
                                            </div>
